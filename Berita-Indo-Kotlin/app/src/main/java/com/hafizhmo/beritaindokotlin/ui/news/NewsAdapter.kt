package com.hafizhmo.beritaindokotlin.ui.news
...
class NewsAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder) {
            ...
            binding.textPubdate.text = arrNews[position].pubDate?.substring(0, 10)
            binding.textDescripiton.text = arrNews[position].description
